        ...
        <div class="row">
            ...
            <div class="col-md-2 mx-auto">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a class="imgLink" href="./rooms.php" target="_parent">
                    ...
                    <li>
                        <a class="imgLink" href="./events.php" target="_parent">
                    ...
                    <li>
                        <a class="imgLink" href="./dining.php" target="_parent">
                    ...
                    <li>
                        <a class="imgLink" href="./about.php" target="_parent">
